...
void showAnalogRGB( const CRGB& rgb) {
  ...
  analogWrite(REDPIN,   rgb.r);  //for common anode
...
void colorBars() {
  ...
  for(;;){
  fill_solid(leds,1,CRGB::Red);   showAnalogRGB( leds[0] ); delay(250);
  // fill_solid(leds,1,CRGB::Blue);  showAnalogRGB( leds[0] ); delay(250);
  }
}
