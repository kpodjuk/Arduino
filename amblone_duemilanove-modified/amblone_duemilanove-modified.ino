...
#define C_SF1 112 // Startflag for 1-channel mode (1 RGB channel)
...
#define C_END 111 // End flag
#define C_ESC 153 // Escape character
    ...
    case S_WAIT_FOR_SF:
      ...
      switch (Recv) {
        case C_SF1:
          ...
          ChannelMode = 1;
          Serial.print("started in 1 channel mode");
          State = S_RECV_RGB;
          ByteCount = 0;
          return false;
        case C_SF2:
      ...
      break;
    case S_RECV_RGB:
          Serial.println("RGB Data reception state");

      // =============================== RGB Data reception state
      switch (Recv) {
        case C_SF1:
          Serial.println("set mode to 1 channel mode");
          // Start flag for 1-channel mode
          ChannelMode = 1;
          State = S_RECV_RGB;
          ByteCount = 0;
